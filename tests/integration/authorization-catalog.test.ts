...
const EXPECTED_POLICIES = [
  ...
  ["conversation_assignments", "conversation_assignments_select", "SELECT"],
  ["conversations", "conversations_select", "SELECT"],
  ["invitations", "invitations_select", "SELECT"],
  ["lead_sources", "lead_sources_select", "SELECT"],
  ["message_delivery_attempts", "message_delivery_attempts_select", "SELECT"],
  ["message_status_events", "message_status_events_select", "SELECT"],
  ...
  ["whatsapp_accounts", "whatsapp_accounts_select", "SELECT"],
] as const;
