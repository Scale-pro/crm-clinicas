...
export default async function NewContactPage({ searchParams }: { searchParams: Promise<{ error?: string; existing?: string }> }) {
  ...
  if (!permission.allowed) return <div className="p-4 sm:p-5"><AccessDeniedState title="Acesso negado" description="Seu papel não permite criar contatos." /></div>;
